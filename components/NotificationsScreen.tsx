...
const ICON_MAP: Record<NotifType, { icon: string; color: string; bg: string }> = {
  ...
  session_confirm_request: { icon: 'clipboard-check-outline', color: COLORS.primary, bg: COLORS.primaryPale },
  session_confirmed: { icon: 'check-decagram', color: COLORS.success, bg: COLORS.success + '15' },
  session_disputed:  { icon: 'alert-circle-outline', color: COLORS.error, bg: COLORS.error + '12' },
