    ...
    <SafeAreaView style={s.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.content}>
        ...
        <View style={s.section}>
          ...
          <View style={s.card}>
            <MenuItem icon="flag-outline" iconColor={D.error} iconBg={D.error + '12'} label="회원 신고" sub="부적절한 행동·허위 정보 신고" onPress={() => setReportModal(true)} accent />
            <Divider />
            <MenuItem icon="alert-circle-outline" iconColor={D.amber} iconBg={D.amberPale} label="부적절한 콘텐츠 신고" sub="불법·음란·혐오 콘텐츠 신고" onPress={() => setReportModal(true)} />
            <Divider />
