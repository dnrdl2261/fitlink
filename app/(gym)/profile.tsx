...
const styles = StyleSheet.create({
  ...
  facilityText: { fontSize: 13, color: '#0057ff', fontWeight: '600' },
  priceRow: {
    flexDirection: 'row',
  ...
  priceValue: { fontSize: 14, fontWeight: '700', color: '#0057ff' },
  ruleItem: { flexDirection: 'row', gap: 8, alignItems: 'flex-start' },
  ruleBullet: { fontSize: 14, color: '#0057ff', lineHeight: 22, fontWeight: '700' },
