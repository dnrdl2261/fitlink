...
export default function GymTrainersScreen() {
  ...
  const executeConfirm = () => {
    ...
    if (confirmAction.kind === 'approve') {
      ...
      setConfirmAction({ kind: 'done', icon: 'check-circle', iconColor: '#0057ff', message: `${confirmAction.name} 트레이너가 파트너로 승인되었습니다.` });
      ...
      setConfirmAction({ kind: 'done', icon: 'account-check', iconColor: '#0057ff', message: `${confirmAction.trainerName} 트레이너를\n블랙리스트에서 해제했습니다.` });
    }
  };
            ...
            {confirmAction?.kind === 'approve' && (
              <>
                <View style={[cfStyles.iconBox, { backgroundColor: '#ECFDF9' }]}>
                  <MaterialCommunityIcons name="account-check-outline" size={36} color="#0057ff" />
                </View>
...
const styles = StyleSheet.create({
  ...
  fab: {
    ...
    shadowColor: '#0057ff', shadowOffset: { width: 0, height: 4 },
  ...
  approveBtn: { backgroundColor: '#0057ff' },
  ...
  inviteAvatar: {
    width: 46, height: 46, borderRadius: 23,
    backgroundColor: '#0057ff' + '20',
    alignItems: 'center', justifyContent: 'center',
  },
  inviteAvatarText: { fontSize: 18, fontWeight: '700', color: '#0057ff' },
  ...
  inviteSpecChip: {
    backgroundColor: '#0057ff' + '15',
    paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6,
  },
  inviteSpecText: { fontSize: 11, fontWeight: '600', color: '#0057ff' },
  inviteItemBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 4,
    backgroundColor: '#0057ff',
...
const cfStyles = StyleSheet.create({
  ...
  confirmBtn: {
    flex: 1, paddingVertical: 13, borderRadius: 12,
    alignItems: 'center', backgroundColor: '#0057ff',
  },
