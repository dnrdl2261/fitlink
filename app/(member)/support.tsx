...
const FAQS = [
  { q: '예약을 취소하고 싶어요. 환불은 어떻게 되나요?', a: '아직 이용하지 않은 회차는 시점과 관계없이 100% 환불됩니다. 결제 대금은 회사가 보관하고 있다가 회원님이 세션 완료를 확인할 때마다 트레이너에게 정산되기 때문입니다. 이미 완료한 세션과 정당한 사유 없는 노쇼(미출석) 회차는 환불되지 않습니다.' },
...
const BOT_MAP: Record<string, string> = {
  '환불': '미사용 회차는 시점과 무관하게 100% 환불됩니다. 완료한 세션과 노쇼 회차는 환불되지 않습니다.',
