              ...
              <View style={s.modalSheet}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                  {REPORT_REASONS.map((r) => (
                    <TouchableOpacity
                      key={r}
                      style={[s.reasonRow, selectedReason === r && s.reasonRowActive]}
                ...
                <TouchableOpacity
                  style={[s.reportBtn, !selectedReason && s.reportBtnOff]}
...
function MenuItem({
  icon, iconColor, iconBg, label, sub, onPress, accent,
}: {
  icon: string; iconColor: string; iconBg: string;
  label: string; sub: string; onPress: () => void; accent?: boolean;
}) {
  return (
...
const s = StyleSheet.create({
  ...
  banner: {
    ...
    backgroundColor: D.primaryGlow, borderRadius: 18,
  ...
  toggle: {
    ...
    backgroundColor: D.border, padding: 2,
  ...
  currentBadge: {
    backgroundColor: D.success + '18', borderRadius: 6,
    paddingHorizontal: 6, paddingVertical: 2,
  },
  currentBadgeText: { fontSize: 10, fontWeight: '700', color: D.success },
  logSignOut: {
    paddingHorizontal: 10, paddingVertical: 5,
    borderRadius: 8, borderWidth: 1, borderColor: D.error + '50',
  },
  logSignOutText: { fontSize: 11, fontWeight: '600', color: D.error },
  allSignOutBtn: {
    margin: 16, marginTop: 8, paddingVertical: 12, borderRadius: 12,
    backgroundColor: D.error + '10', borderWidth: 1, borderColor: D.error + '30',
    alignItems: 'center',
  },
  ...
  reasonRow: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: D.bg,
  },
  ...
  reportBtn: {
    ...
    backgroundColor: D.error, alignItems: 'center',
  },
